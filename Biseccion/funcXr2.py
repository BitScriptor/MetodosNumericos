def raiz(fxl,fxu, fa, fb, fc, fcoordenadaX):#deficion de la funcion que itilizaremos para el caso
	...
	while (round(centinela1, 4) != round(centinela2, 4)):#damos el numero de iteracion hasta que los tres numeros despues del punto sean estaticos
		...
		subint = ((fa*(fxl**2)) + (fb*fxl) + fc)  *  ((fa*(fxr**2)) + (fb*fxr) + fc)#determinamos el subintervalo
